...
"Резюме" в вольном стиле (и с некоторой, хм, "выдержанностью")…
...
- [Свой Gitlab](https://gitlab.cyberbrain.cc), пытается работать в виртуальной машине, запущенной на мини-пк, живущем за телевизором. Обычно лениво лежит, но иногда изволит работать.
